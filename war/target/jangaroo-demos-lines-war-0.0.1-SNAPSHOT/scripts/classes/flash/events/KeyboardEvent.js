...
"public class KeyboardEvent extends flash.events.Event",function($$l,$$private){var is=joo.is,assert=joo.assert,trace=joo.trace,$$bound=joo.boundMethod,$super=$$l+'super',$clone=$$l+'clone',$toString=$$l+'toString';return[ 
   ...
   */
  "public var",{ charCode/*:uint*/: undefined},
   ...
   */
  "public var",{ commandKey/*:Boolean*/: undefined},
   ...
   */
  "public var",{ controlKey/*:Boolean*/: undefined},
   ...
   * @see flash.system.IME
   */
  "public var",{ keyCode/*:uint*/: undefined},
   ...
   */
  "public var",{ keyLocation/*:uint*/: undefined},
   ...
   * @see #charCode
   */
  "public function KeyboardEvent",function $KeyboardEvent(type/*:String*/, bubbles/*:Boolean = true*/, cancelable/*:Boolean = false*/, charCodeValue/*:uint = 0*/,
                                ...
                                controlKeyValue/*:Boolean = false*/, commandKeyValue/*:Boolean = false*/) {if(arguments.length<11){if(arguments.length<10){if(arguments.length<9){if(arguments.length<8){if(arguments.length<7){if(arguments.length<6){if(arguments.length<5){if(arguments.length<4){if(arguments.length<3){if(arguments.length<2){bubbles = true;}cancelable = false;}charCodeValue = 0;}keyCodeValue = 0;}keyLocationValue = 0;}ctrlKeyValue = false;}altKeyValue = false;}shiftKeyValue = false;}controlKeyValue = false;}commandKeyValue = false;}
