...
"public class Capabilities",function($$l,$$private){var is=joo.is,assert=joo.assert,trace=joo.trace,$$bound=joo.boundMethod,$super=$$l+'super';return[ 
   ...
   */
  "public static function get isDebugger",function get$isDebugger()/*:Boolean*/ {
    return true;
  },
   ...
   */
  "public static function get os",function get$os()/*:String*/ {
    return "jangaroo";
  },
   ...
   */
  "public static function get version",function get$version()/*:String*/ {
    return "jangaroo";
  },
