...
trace(container.getChildAt(2) == sprite2); // true
  ...
  "override protected function updateSize",function updateSize()/*:void*/ {
    this[$updateSize]();
    this[$children].forEach(function flash$display$DisplayObjectContainer$199_22(child/*:DisplayObject*/)/*:void*/ {
      child.updateSize();
    });
  },
